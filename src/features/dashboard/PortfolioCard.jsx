 ...
 */
export default function PortfolioCard({ card, onRemove, onEdit, onExpand, fill = false }) {
  ...
  return <CardFrame title={card.title} onRemove={onRemove} onEdit={onEdit} onExpand={onExpand} fill={fill}>{table}</CardFrame>;
}
